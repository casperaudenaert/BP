...
Het vakgebied heeft verschillende mogelijkheden om dit aan te pakken waaronder:
\begin{itemize}
    \item supervised learning
    \item unsupervised learning
    \item reinforcement earning
\end{itemize}
...
\subsubsection{Reinforcement earning}

\subsection{Data Preprocessing}
Om correcte beslissingen te maken met het machine learning model moet de data opgekuist zijn.
