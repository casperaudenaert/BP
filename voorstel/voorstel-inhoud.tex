...
\begin{tikzpicture}[node distance=2cm, every node/.style={font=\small}]
  ...
  \node (pro1) [rectangle, draw, minimum width=3cm, minimum height=1cm, text centered, text width=3cm, below of=pro0] {Onderzoek naar het lokaal draaien van Kubeflow pipelines};
