...
Binnen het domein van datamanagement beklemtonen \citet{Samad2018} en \citet{RMV2020} de cruciale aspecten van respectievelijk het optimaliseren van beperkte data samples en de implementatie van Continuous Integration in de datapipeline.
...
In dit onderzoeksvoorstel treed ook \citet{Zhang2022} naar voren als een belangrijk figuur met zijn eigen bijdragen.
...
\subsection{Fase 3: Short list (2 week)}
