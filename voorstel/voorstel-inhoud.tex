...
Deze literatuurstudie heeft een grondig inzicht geboden in het lokaal uitvoeren van Machine Learning pipelines, waarbij de focus lag op de fundamentele elementen van Machine Learning en pipelines. Verder werd de vooruitgang op het gebied van Machine Learning frameworks en libraries belicht, waarbij tools zoals Kubeflow, Kedro en MLflow werden besproken voor het beheren, structureren en implementeren van Machine Learning projecten. Deze frameworks bieden een gestandaardiseerde en efficiënte aanpak voor het bouwen en beheren van Machine Learning pipelines.
