...
Kubeflow \autocite{Kubeflow2021} is een open-source platform dat een collectie van Machine Learning tools biedt die compatibel zijn met Kubernetes. Het wordt vooral gebruikt in DevOps-frameworks, waar het Machine Learning stacks en componenten zoals PyTorch en TensorFlow\newline kan beheren \autocite{Chandana2021}.\newline
Kubeflow kan ook gebruikt worden bij end-to-end Machine Learning-oplossingen,\newline  waarbij pipeline-onderdelen de uitvoering van taken en het beheer van artefacten vereenvoudigen \autocite{Bisong2019}.
