...
\begin{tikzpicture}[node distance=2cm, every node/.style={font=\small}]
  ...
  \node (pro1) [process, below of=pro0] {Onderzoek naar het lokaal draaien van Kubeflow pipelines};
  ...
  \node (pro5) [process, below of=pro4] {Analyseren en vergelijken van resultaten};
