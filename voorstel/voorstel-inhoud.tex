...
Programmeerbibliotheken zijn verzamelingen van vooraf geschreven code die hergebruikt kan worden om het ontwikkelproces te vereenvoudigen. Ze kunnen gebruik worden voor verschillende taken zoals het ophalen van documenten, sorteren en indexeren (Davis, 1988), en software ontwikkeling (Denert, 1979).
\subsection{Kubeflow}
Kubeflow is een open-source platform met een collectie van machine learning tools biedt die compatiebel zijn met Kubernetes \autocite{Stein2020}. Het word vooral gebruik in DevOps-frameworks, waar het machine learning stacks en componenten zoals PyTorch en TensorFlow kan beheren \autocite{NGC2021}.
Kubeflow kan ook gebruik worden van end-to-end machine learning-oplossingen, waarbij pipeline-onderdelen taakuitvoering en artefactbeheer vergemakkelijken(Bisong 2019).
