...
% TODO: ik heb de figuur verwijderd, die had geen meerwaarde.
...
Figuur~\ref{fig:CICD_flow} toont de flow van een CI/CD pipeline. % TODO: zet dan hierachter wat je hieronder hebt zodat het er beter uitziet in de pdf
...
Onderstaande code is een voorbeeld van een Machine Learning-pipeline in Kedro: 

% TODO: eigenlijk moet je codefragmenten ook voorzien van een caption en vooraan een "Lijst van Codefragmenten" toevoegen.
...
if __name__ == "__main__":
    train()
\end{minted}
Deze code is een normale code voor het maken van een Machine Learning pipeline, echter zijn er enkele verschillen aangezien dat MLflow gebruikt wordt.
In de code zijn de functies \texttt{log\_metrics} en \texttt{log\_model} te zien. Deze zorgen ervoor dat bepaalde metrics te zien zijn bij de resultaten alsook dat het model word bijgehouden.

% TODO: wordt MLFlow niet eerder gebruikt als onderdeel van een pipeline i.p.v. om een pipeline mee te maken?
...
% TODO: ik zie geen aangeduide lijn
...
def train():
    ...
    accuracy = accuracy_score(y_test, preds)
\end{minted}
In Dagster worden gegevens en taken gemodelleerd als \texttt{assets}, die worden aangegeven met de \texttt{@asset} decorator. Deze decorator wordt gebruikt om aan te geven dat een functie een gegevensbron of een taak is binnen de data pipeline. Hierna kan via de webinterface elke asset uitgevoerd worden.
\subsection{Luigi}
...
% TODO: caption bij de tabel
% TODO: niet zomaar de tabel geven. Je moet die ook bespreken. Je kan bv. zeggen "Na analyses van alle voorgaande secties en de requirementsanalyse, toont Tabel ... een overzicht van de frameworks en hun mogelijkheden."
% TODO: je moet hier dan ook de short list bepalen en uitleggen waarom je die frameworks hebt gekozen
...
\begin{landscape}
    ...
    \begin{tabular}[c]{@{}l@{}}Leesbaar\\ formaat\end{tabular}             & YAML                                                                & Python code                                                        & Python code                                                       & Python code                                                       & YAML                                                              & \begin{tabular}[c]{@{}l@{}}YAML\\ en Python \\ code\end{tabular}  \\ \hline
