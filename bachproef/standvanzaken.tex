...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{MLflow}
MLflow is een open-source Python-bibliotheek ontwikkeld door Databricks die een uitgebreide set functionaliteiten biedt voor het beheren van Machine Learning (ML)-projecten. De vier pijlers van MLflow zijn Tracking, Projects, Models en Registry.
\subsection*{Functionaliteiten van MLflow}
...
\subsection*{Voordelen van MLflow voor onderzoekers}
...
\subsection*{Mogelijke nadelen van MLflow voor lokaal uitvoeren van pipelines}
...
Kubeflow is een open-source Machine Learning-toolkit die is ontworpen voor Kubernetes. Het biedt een krachtige infrastructuur voor onderzoekers om Machine Learning-pipelines op te zetten en te beheren in zowel lokale als cloudomgevingen.
...
spec:
  ...
  - name: "Classifier Pipeline"
    description: "Een pipeline om een classifier te trainen en evaluaren"
    steps:
    - name: "Load Data"
      template: "load-data"
    - name: "Split Data"
...
from zenml.steps.evaluator import Evaluator
from zenml.steps.preprocesser import StandardPreprocesser
from zenml.steps.split import Split
from zenml.steps.trainer import Trainer
...
preprocesser = StandardPreprocesser(
    name="my_preprocesser"
)
trainer = Trainer(
    name="my_trainer",
...
training_pipeline = TrainingPipeline(
    ...
    steps=[split, preprocesser, trainer, evaluator]
)
