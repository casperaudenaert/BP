...
Na analyse van alle voorgaande secties en de requirementsanalyse, toont \ref{tab:table-vergelijking} een overzicht van de frameworks en hun mogelijkheden. Deze tabel biedt een gedetailleerd vergelijk tussen de verschillende machine learning frameworks op basis van een reeks criteria die essentieel zijn voor het opzetten en uitvoeren van pipelines.
\begin{landscape}
    \begin{table}[]
...
Op basis van tabel \ref{tab:table-vergelijking} en de specifieke vereisten van de requirementsanalyse, is er een shortlist gemaakt van de meest geschikte frameworks: Dagster, Prefect en ZenML. Deze keuze is gebaseerd op de volgende overwegingen:
