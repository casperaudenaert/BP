...
In deze stand van zaken worden verschillende concepten en principes besproken om het nodige inzicht te creëren omtrent het lokaal uitvoeren van machine learning pipelines. Allereerst zal er toegelicht worden wat machine learning exact inhoudt, gevolgd door een iets meer gedetailleerde uitleg over de werking en toepassing ervan. Daarna zal een belangrijk concept besproken worden, namelijk CI/CD (Continuous Integration/Continuous Deployment) pipelines, en hoe deze een cruciale rol spelen in de ontwikkeling en implementatie van machine learning modellen.

Vervolgens wordt er een overzicht gegeven van verschillende frameworks die gebruikt worden voor het bouwen en beheren van machine learning pipelines. Enkele van de meest populaire frameworks zullen in detail besproken worden, waarbij hun voor- en nadelen worden belicht. Daarna zal er een vergelijking gemaakt worden op basis van een requirementanalyse, waarbij de verschillende benaderingen voor het lokaal uitvoeren van deze pipelines worden geanalyseerd in het licht van diverse vereisten.
...
Codeframent~\ref{code:example-ZenML} is een voorbeeld van een Machine Learning pipeline in ZenML. In deze code maakt ZenML gebruik van decorators, deze decorators zijn:
\begin{itemize}
...
Voordelen van Dagster voor het lokaal uitvoeren van ML pipelines zijn:
\begin{itemize}
...
Ook zijn er een aantal mogelijke nadelen verbonden aan Luigi:
\begin{itemize}
...
Aan de hand van deze criteria zal besloten worden welke frameworks gekozen zullen worden om een Proof of Concept uit te werken.

Na analyse van alle voorgaande secties en de requirementsanalyse, toont Tabel~\ref{tab:table-vergelijking} een overzicht van de frameworks en hun mogelijkheden. Deze tabel biedt een gedetailleerde vergelijking tussen de verschillende machine learning frameworks op basis van een reeks criteria die essentieel zijn voor het opzetten en uitvoeren van pipelines.

\begin{landscape}
    \begin{table}[]
    \begin{tabular}{|l|l|l|l|l|l|l|}
    \hline
    Criteria                                                               & Kedro                                                               & Luigi                                                              & Prefect                                                           & Dagster                                                           & ZenML                                                             & Kubeflow                                                          \\ \hline
    ...
    \begin{tabular}[c]{@{}l@{}}Leesbaar\\ formaat\end{tabular}             & \begin{tabular}[c]{@{}l@{}}YAML en \\ Python code\end{tabular}      & Python code                                                        & Python code                                                       & Python code                                                       & Python code                                                       & \begin{tabular}[c]{@{}l@{}}YAML\\ en Python \\ code\end{tabular}  \\ \hline
    Lokale uitvoering                                                      & Ja                                                                  & Ja                                                                 & Ja                                                                & Ja                                                                & Ja                                                                & Ja                                                                \\ \hline
    \begin{tabular}[c]{@{}l@{}}Data verzamelen\\ en verwerken\end{tabular} &                                                                     & Ja                                                                 & Ja                                                                & Ja                                                                & Ja                                                                & Ja                                                                \\ \hline
    \begin{tabular}[c]{@{}l@{}}Model trainen\\ en evalueren\end{tabular}   & Ja                                                                  & Ja                                                                 & Ja                                                                & Ja                                                                & Ja                                                                & Ja                                                                \\ \hline
    Model deployen                                                         & Ja                                                                  & Ja                                                                 & Ja                                                                & Ja                                                                & Ja                                                                & Ja                                                                \\ \hline
    Relatieve Leercurve                                                    & Gemiddeld                                                           & Laag                                                               & Gemiddeld                                                         & Hoog                                                              & Gemiddeld                                                         & Zeer hoog                                                         \\ \hline
    Documentatie                                                           & Goed                                                                & Minimaal                                                           & Uitgebreid                                                        & Uitgebreid                                                        & Ontwikkelend                                                      & Goed                                                              \\ \hline
    \end{tabular}
    \caption{\label{tab:table-vergelijking}Vergelijking van Machine Learing frameworks voor het uitvoeren van pipelines.}
    \end{table}
\end{landscape}

Op basis van Tabel~\ref{tab:table-vergelijking} en de specifieke vereisten van de requirementsanalyse, is er een short list gemaakt van de meest geschikte frameworks: Dagster, Prefect en ZenML. Deze keuze is gebaseerd op de volgende overwegingen:

\begin{itemize}
    \item \textbf{Prefect}: Prefect is een machine learning framework dat uitgebreide mogelijkheden biedt voor het opzetten, uitvoeren en beheren van data pipelines. Het biedt een solide basis voor reproducibility, uitstekende documentatie en goede ondersteuning voor zowel lokale als cloudgebaseerde uitvoering.

    \item \textbf{ZenML}: ZenML is een opkomend framework dat zich richt op het stroomlijnen van het machine learning proces, van gegevensbeheer tot modelversiebeheer en experiment tracking. Het biedt een intuïtieve interface en integraties met populaire machine learning libraries.

    \item \textbf{Dagster}: Dagster is een krachtig framework dat zich richt op het bouwen van data applicaties met een sterke nadruk op het garanderen van data integriteit en betrouwbaarheid. Het biedt geavanceerde functionaliteiten zoals type checking, unit testing en dependency management.
\end{itemize}

Voor elk van deze drie frameworks zal later een Proof of Concept worden ontwikkeld om de lokale uitvoering van Machine Learning pipelines te demonstreren.
