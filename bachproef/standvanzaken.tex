...
\textcite{Kedro2024}, een open-source Python library voor het bouwen van betrouwbare, reproduceerbare en onderhoudbare Machine Learning-pipelines, komt naar voren als een krachtig instrument voor onderzoekers bij het opzetten en beheren van lokaal uitgevoerde ML-pipelines. Deze scriptie onderzoekt de verdiensten van het gebruik van Kedro in lokale ML-omgevingen en benadrukt de voordelen ervan bij het stroomlijnen van MLOps-praktijken voor onderzoek en scriptieontwikkeling.
...
\begin{table}[htbp]
    \centering
    \caption{Frameworks vergelijking}
      \begin{tabular}{|l|l|l|l|l|l|l|l|l|}
      \hline
      \textbf{Framework} & \textbf{OS compatibiliteit} & \textbf{Reproduceerbaarheid} & \textbf{Minimumvereisten} & \textbf{Cloud compatibiliteit} & \textbf{Leesbaar formaat} & \textbf{Lokale uitvoering} & \textbf{Data verzamelen/verwerken} & \textbf{Model trainen/evalueren} & \textbf{Model deployen} \\
      \hline
      \multirow{5}[2]{*}{Kedro} & Windows, macOS, Linux & Ja    & Ja    & Ja (Azure ML, AWS SageMaker) & YAML  & Ja    & Ja    & Ja    & Ja \\
  \cline{2-10}          & \multirow{4}[1]{*}{\textbf{Luigi}} & Windows, macOS, Linux & Ja    & Ja    & Ja (Azure ML, AWS SageMaker) & Python code & Ja    & Ja    & Ja \\
  \cline{2-10}          &       & Windows, macOS, Linux & Ja    & Ja    & Ja (Azure ML, AWS SageMaker) & Python code & Ja    & Ja    & Ja \\
  \cline{2-10}          &       & Windows, macOS, Linux & Ja    & Ja    & Ja (Azure ML, AWS SageMaker) & Python code & Ja    & Ja    & Ja \\
  \cline{2-10}          &       & Windows, macOS, Linux & Ja    & Ja    & Ja (Azure ML, AWS SageMaker) & Python code & Ja    & Ja    & Ja \\
      \hline
      \end{tabular}%
