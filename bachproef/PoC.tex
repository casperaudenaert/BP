...
\begin{minted}[frame=lines,breaklines,linenos]{text}
...
De volgende hoodstukken zal gebruik maken van verschillende frameworks, deze frameworks hebben allemaal de mogelijkheid om lokaal een Machine Learning pipeline uit te voeren en deze frameworks voldoen ook aan alle nodige criteria van het requirementsanalyse.
\section*{Prefect}
