...
In dit geval heeft de ``@flow'' nog extra parameters, deze betekend het volgend:
...
\begin{itemize}
    ...
    \item log_prints: Geeft alle print commando\'s weer dat in de Python code werd gebruikt, in dit geval is dat ``True'' dat maakt het gemakkelijk tijden het ontwikkelen van de pipeline.
\end{itemize}
