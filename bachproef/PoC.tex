...
\begin{itemize}
    \item Parameter Logging: Het commando hiervoor is \verb+mflow().log\_param+. Dit houdt alle parameters bij van het model, zoals het aantal epochs of de batchgrootte.
