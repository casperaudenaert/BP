...
Nadata MLflow geimporteerd is, moeten we alle parameters veranderen in de code zodat deze de resulaten naar de juiste server worden gestuurd en de juiste resulaten worden bijgehouden.
